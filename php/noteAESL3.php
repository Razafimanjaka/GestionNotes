                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <select name="num" id="matr" class="form-control">
                                ...
                                <?php
                                   $recherche = $conn->query('SELECT matricule FROM etudiant WHERE mention="AES" AND niveau = "L3"');
                ...
                <div class="col-md-8">
                    ...
                    ?>
                            <table>
                                ...
                                <?php 
                                $rekety = $conn->prepare("SELECT numero_etu,nom,prenom,nomMat,noteNormal FROM etudiant,matiere,note_et WHERE matiere.mention='aes' AND numero_etu=matricule AND codeM=codeMat AND niveau='L3'");
