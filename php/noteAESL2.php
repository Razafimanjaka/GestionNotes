                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <select name="num" id="matr" class="form-control">
                                ...
                                <?php
                                   $recherche = $conn->query('SELECT matricule FROM etudiant WHERE mention="AES" AND niveau = "L2"');
                ...
                <div class="col-md-8">
                    ...
                    ?>
                            <table>
                                ...
                                <?php 
                                $rekety = $conn->prepare("SELECT numero_etu,nom,prenom,nomMat,noteNormal FROM etudiant,matiere,note_et WHERE numero_etu=? AND matiere.mention='aes' AND numero_etu=matricule AND codeM=codeMat");
                    ...
                    ?>
                            <table>
                                ...
                                <?php 
                                $rekety = $conn->prepare("SELECT numero_etu,nom,prenom,nomMat,noteNormal FROM etudiant,matiere,note_et WHERE matiere.mention='aes' AND numero_etu=matricule AND codeM=codeMat AND niveau='L2'");
                        ...
                        if(isset($_POST['modify'])){
                            if(isset($_POST['note']) && !empty($_POST['note'])){
                                if($_POST['note']>20 || $_POST['note']<0){
                                    ...
                                    $rekt = $conn->prepare('SELECT coeff FROM matiere WHERE mention="aes" AND codeMat = ?');
                            ...
                            if(isset($_POST['note']) && !empty($_POST['note'])){
                                ...
                                if($res=$reket_verf->fetch()){
                                    ...
                                    if($_POST['note']>20 || $_POST['note']<0){
                                        ...
                                        if($res=$verif->fetch()){
                                            $nbrNote = $res[0];
                                            $nbrMat = $conn->prepare("SELECT COUNT(*) FROM matiere WHERE mention='aes'");
